...
* [ ] B1.5 — Update `panels.py` to add a "Whitewater" sub-panel with class-toggle visibility + thresholds.
* [ ] B1.6 — Smoke test: install zip → toggle σ in N-panel → bake → mesh shows a rounded drop.
